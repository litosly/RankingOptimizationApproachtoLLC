...
if __name__ == "__main__":
    ...
    parser.add_argument('--topk', dest='topk', default=10,
                        help='Topk affected/unaffected items. (default: %(default)s)')

    parser.add_argument('--lamb', dest='lamb', default=10,
                        help='Lamb parameter used in LP-Rank. (default: %(default)s)')
